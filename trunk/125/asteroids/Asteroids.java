...
public class Asteroids extends JPanel implements Runnable, KeyListener {
  ...
  public void loadSounds() {
    ...
    System.out.println(Asteroids.class.getClassLoader().getResource("crash.au").toString());
    crashSound     = getAudioClip(Asteroids.class.getClassLoader().getResource("crash.au"));
    explosionSound = getAudioClip(Asteroids.class.getClassLoader().getResource("explosion.au"));
    fireSound      = getAudioClip(Asteroids.class.getClassLoader().getResource("fire.au"));
    missleSound    = getAudioClip(Asteroids.class.getClassLoader().getResource("missle.au"));
    saucerSound    = getAudioClip(Asteroids.class.getClassLoader().getResource("saucer.au"));
    thrustersSound = getAudioClip(Asteroids.class.getClassLoader().getResource("thrusters.au"));
    warpSound      = getAudioClip(Asteroids.class.getClassLoader().getResource("warp.au"));
    
    crashSound.start();     crashSound.stop();
    explosionSound.start(); explosionSound.stop();
    fireSound.start();      fireSound.stop();
    missleSound.start();    missleSound.stop();
    saucerSound.start();    saucerSound.stop();
    thrustersSound.start(); thrustersSound.stop();
    warpSound.start();      warpSound.stop();
  }
