...
public class SwingBotFramework extends BotFramework implements ActionListener
{
     ...
     */
    public SwingBotFramework(String host, String username, String password) throws XMPPException
    {
     ...
     * 			If any problems arise, this is thrown
     */
    public SwingBotFramework(String host, String username, String password, int port) throws XMPPException
    {
        // Don't need any of the parameters really, just for compatibilities' sake
